...
import { useAuth, obfuscate } from '@/lib/auth';
...
export default function EditProfileModal({ open, onClose }: Props) {
  ...
  async function handleSave() {
    ...
    // Also update the quiz_attempts and learner_assessments going forward
    // (no backfill needed — new records use the updated role)
    setSaving(false);
    setSaved(true);
    setTimeout(() => {
      setSaved(false);
